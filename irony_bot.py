...
#Submission Line 2 (Class Number)
                                ...
                                if reply2.content.lower() == "1" or reply2.content.lower() == "2" or reply2.content.lower() == "3" or reply2.content.lower() == "4" or reply2.content.lower() == "5" or reply2.content.lower() == "6" or reply2.content.lower() == "7" or reply2.content.lower() == "8" or reply2.content.lower() == "9" or reply2.content.lower() == "10" or reply2.content.lower() == "11" or reply2.content.lower() == "12" or reply2.content.lower() == "13" or reply2.content.lower() == "14" or reply2.content.lower() == "15" or "whittle" in reply2.content.lower() or "vangoor" in reply2.content.lower() or "castillo" in reply2.content.lower() or "vecziedins" in reply2.content.lower() or "thane" in reply2.content.lower() or "donohue" in reply2.content.lower() or "vogl" in reply2.content.lower() or "beckwith" in reply2.content.lower() or "burke" in reply2.content.lower() or "rizley" in reply2.content.lower() or "stachura" in reply2.content.lower() or "jeroudi" in reply2.content.lower() or "miller" in reply2.content.lower():
                                    if reply2.content.lower() == "1" or "whittle" in reply2.content.lower():
                                    ...
                                    elif reply2.content.lower() == "3" or "castillo" in reply2.content.lower():
                                    ...
                                    elif reply2.content.lower() == "5" or "thane" in reply2.content.lower():
                                        classnumber = "5 - DP Biology (Thane)"
                                    elif reply2.content.lower() == "6" or "donohue" in reply2.content.lower():
                                        classnumber = "6 - DP English (Donohue)"
                                    elif reply2.content.lower() == "7" or "vogl" in reply2.content.lower():
                                        classnumber = "7 - DP Chemistry (Vogl)"
                                    elif reply2.content.lower() == "8" or "beckwith" in reply2.content.lower():
                                    ...
                                    elif reply2.content.lower() == "10" or "rizley" in reply2.content.lower():
                                    ...
                                    elif reply2.content.lower() == "12" or "jeroudi" in reply2.content.lower():
                                        classnumber = "12 - Music Theory (Jeroudi)"
                                    elif reply2.content.lower() == "13":
                                        classnumber = "13 - TOK (Global)"
                                    elif reply2.content.lower() == "14":
                                        classnumber = "14 - EPIC (Global)"
                                    elif reply2.content.lower() == "15" or "miller" in reply2.content.lower():
                                                ...
                                                #If Yes Tag
                                                    ...
                                                    #If No Note
                                                                if reply5.content.lower() == "no":
                                                                    postembed=discord.Embed(title=f"New Submission to Ironic®", description=f"To {classnumber}", color=0xb18cfe)
                                                                    ...
                                                                    postembed.add_field(name="Post ID", value="Not Yet Determined", inline=True)
...
client.run('ODExOTg4ODgxNzEzMDA0NjA0.YC6Nkw.0ra7o8sqxWkj6WAH-9MX1pBmBc4')
